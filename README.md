...
- Tokens signed with unique secrets
...
### Data Protection
- MongoDB auto-expiring indexes for OTP and tokens
...
OTP codes are printed to console in MOCK mode:
```
📧 EMAIL SERVICE (DEVELOPMENT MODE - MOCK)
To: skandana@example.com
